...
function loadDataTable() {
    datatable = $('#vinylPlayerData').DataTable({
        "language": {
        ...
        "ajax": {
            "url": "/Admin/VinylPlayer/GetAll"
        },
        "columns": [
            { "data": "name", "width": "15%" },
            { "data": "manufacturer.name", "width": "15%" },
            { "data": "description", "width": "15%" },
            { "data": "connectivity", "width": "15%" },
            { "data": "speed", "width": "15%" },
            { "data": "motor", "width": "15%" },
            ...
            { "data": "price", "width": "15%" },
            {
                ...
                "render": function (data) {
                    return `
                        ...
                        <a href="/Admin/VinylPlayer/Upsert?id=${data}"
                        class="btn btn-primary mx-2"> <i class="bi bi-pencil-square"></i> Редагувати</a>
                       <a onClick=Delete('/Admin/VinylPlayer/Delete/${data}')
